...
extension UIImagePickerController.Media.Info {
    ...
    public var mediaType: String {
        ...
        return self.dictionary[UIImagePickerControllerMediaType] as! String
    }
    
    ///The original, uncropped image selected by the user.
    public var originalImage: UIImage? {
        
        return self.dictionary[UIImagePickerControllerOriginalImage] as? UIImage
    }
    
    ///Specifies an image edited by the user.
    public var editedImage: UIImage? {
        
        return self.dictionary[UIImagePickerControllerEditedImage] as? UIImage
    }
    
    ///Specifies the cropping rectangle that was applied to the original image.
    public var cropRect: CGRect? {
        
        return (self.dictionary[UIImagePickerControllerCropRect] as? NSValue)?.cgRectValue
    }
    
    ///Specifies the filesystem URL for the movie.
    public var mediaURL: URL? {
        
        return self.dictionary[UIImagePickerControllerMediaURL] as? URL
    }
    ...
    public var referenceURL: URL? {
        ...
        return self.dictionary[UIImagePickerControllerReferenceURL] as? URL
    }
    ...
    public var mediaMetadata: [String: Any]? {
        ...
        return self.dictionary[UIImagePickerControllerMediaMetadata] as? [String: Any]
    }
    ...
    public var livePhoto: PHLivePhoto? {
        ...
        return self.dictionary[UIImagePickerControllerLivePhoto] as? PHLivePhoto
    }
}
